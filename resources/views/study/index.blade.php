...
@section('content')
    <x-main-content title="Master Data">
        ...
        @endif
        <x-table-view title="Data Studi" :searchable="true" :action="route('studies.create')" :pagination="$studies->links()">
                    ...
                    <tbody>
                        @forelse ($studies as $study)
                            <tr>
                                ...
                                <td>
                                    <x-table-view-action
                                        :show="route('studies.show', ['study' => $study->id])"
                                        :edit="route('studies.edit', ['study' => $study->id])"
                                        :delete="route('studies.destroy', ['study' => $study->id])"/>
                                </td>
                            </tr>
                        @empty
                            <tr>
