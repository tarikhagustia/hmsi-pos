...
@section('content')
    <x-main-content title="Laporan">
        <x-table-view title="Laporan Mutasi Siswa" :searchable="false">
            <div class="row">
                <div class="col-sm-4">
                    <form target="_blank" class="form" method="post" action="{{ route('report.mutation.post') }}">
                        @csrf
                        <x-form-select label="Pilih Cabang" name="branch_id" :dataSources="option_data_branches()">
                        </x-form-select>
